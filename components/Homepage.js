      ...
      <div className="content-wrapper">
        <Row style={{ alignItems: "center", flexWrap: "wrap", marginTop: "1em" }}>
          ...
          <Col style={{ width: "max-content", marginTop: "1em" }}>
            <Row>
              <Badge type="secondary" className={`badge-link ${props.theme}`}><a href="https://intuit.com" target="_blank" rel="noreferrer">@INTUIT</a></Badge>
              <Spacer x={.5} />
              <Badge type="secondary" className={`badge-link ${props.theme}`}><a href="https://acelab.tamu.edu" target="_blank" rel="noreferrer">@ACELAB</a></Badge>
              <Spacer x={.5} />
              <Badge type="secondary" className={`badge-link ${props.theme}`}><a href="https://tamudatathon.com" target="_blank" rel="noreferrer">@TAMU_DATATHON</a></Badge>
            </Row>
          </Col>
        </Row>
        <br />
        ...
        My name is <b>Rishabh Tatia</b>. I am a Junior at <a href="https://tamu.edu" className={`about-link tamu ${props.theme}`} target="_blank" rel="noreferrer">Texas A&M University</a> studying Mathematics and Computer Science.
        ...
        <ul>
          <li>I was born on January 3rd 2001 in <a href="https://www.google.com/maps/place/Gwalior,+Madhya+Pradesh,+India/@28.7853139,59.1335284,3.83z/data=!4m5!3m4!1s0x3976c5d1792291fb:0xff4fb56d65bc3adf!8m2!3d26.2195191!4d78.1842041" className={`about-link city ${props.theme}`} target="_blank" rel="noreferrer">Gwalior, India</a>.</li>
          ...
          <li>I enjoy participating in hackathons and am currently a developer and organizer for <a href="https://tamudatathon.com" className={`about-link datathon ${props.theme}`} target="_blank" rel="noreferrer">TAMU Datathon</a>.</li>
          <li>I am currently a web developer at <a href="https://acelab.tamu.edu" className={`about-link tamu ${props.theme}`} target="_blank" rel="noreferrer">Acelab</a> and will be interning at <a href="https://intuit.com" className={`about-link intuit ${props.theme}`} target="_blank" rel="noreferrer">Intuit</a> over Summer 2021.</li>
