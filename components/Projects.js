...
import { Modal, Tag, Row, Card, Spacer, Col, Image, Link, Button, Collapse, useModal } from '@geist-ui/react'
      ...
      <div className="content-wrapper">
        <Collapse.Group style={{ padding: "0", marginTop: "1em" }}>
          <Collapse title="Ongoing" initialVisible style={{ borderTop: "0" }}>
            <Row style={{ flexWrap: "wrap", marginTop: "1em" }}>
              {currentProjectList.map((project, i) =>
                <Card key={`project-card-${i}`} hoverable>
                  <Image src={`img/${project.img}`} height="300" width="300" style={{ objectFit: 'cover' }} />
                  <h4>{project.name}</h4>
          ...
          <Collapse title="Unmaintained" style={{ borderTop: "0" }}>
            <Row style={{ flexWrap: "wrap", marginTop: "1em" }}>
          ...
          <Modal.Content>
            <Row style={{ flexWrap: "wrap" }}>
              <Col className="modal-section">
                <Image src={`img/${chosenProject.img}`} height="250" width="250" style={{ objectFit: 'cover' }} />
              </Col>
              <Col className="modal-section">
                <ul>
                ...
                <Row style={{ flexWrap: "wrap", marginLeft: "20px" }}>
                  {chosenProject.tools.map((t, i) => <>
                    <Tag style={{ marginTop: "0.5em" }}>{t}</Tag>
                    <Spacer x={.5} />
                  </>)}
                </Row>
              </Col>
