  ...
  return (
    <>
        ...
        <div className="flex-center" style={{ width: "100vw" }}>
          <Container style={{ boxShadow: "11px 11px 22px #bfbfbf, -11px -11px 22px #ffffff", margin: "2em", width: "1000px", padding: "2em" }}>
          {/* <Container style={{ width: "1000px", margin: "0px", padding: "0px" }}> */}
            <Row style={{ margin: "0px", paddingBottom: "1em", borderBottom: "1px solid #d9d9d9" }}>
              <Col sm="4">
                <h1>Rishabh Tatia</h1>
              ...
              <Col sm="4" style={{ display: "flex", justifyContent: "right" }}>
                <div>
                  +1-713-208-0982 <br/>
                  tatiaris2001@gmail.com <br/>
                  tatiaris.com/linkedin <br/>
                  tatiaris.com/github
                </div>
              </Col>
            </Row>
            <Row style={{ margin: "0px", marginTop: "1em" }}>
              <Col sm="6" style={{ borderRight: "1px solid #d9d9d9" }}>
                <h3>Education</h3>
                ...
                {/* <div className="section">
                  ...
                  <ul>
                    <li>Developed some product that does something</li>
                  </ul>
                </div> */}
                <div className="section">
                  <span style={{ float: "right" }}>June 2020 - Present</span>
                  <h5><b>TAMU Datathon</b></h5>
                ...
                <div className="section">
                  ...
                  <h5><b>Applied Cognitive Ergonomics Lab</b></h5>
