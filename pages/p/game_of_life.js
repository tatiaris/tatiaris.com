    ...
    <Page id="project-container">
      ...
      <Row style={{ flexWrap: 'wrap' }} justify="center">
        ...
        <Tooltip text={'Next Generation'} placement="bottom" type="dark" enterDelay="1000">
          <Button className="control-btn" size="small" onClick={nextStep}>
            <ChevronRight />
          </Button>
        </Tooltip>
        <Spacer x={1} />
        <Tooltip text={'Reset'} placement="bottom" type="dark" enterDelay="1000">
          <Button className="control-btn" size="small" onClick={handleResetGrid}>
            <RefreshCcw />
          </Button>
        </Tooltip>
        <Spacer x={1} />
        <Tooltip text={'About'} placement="bottom" type="dark" enterDelay="1000">
          <Button className="control-btn" size="small" onClick={(e) => setVisible(true)}>
            <Info />
          </Button>
        </Tooltip>
      </Row>
      ...
      <Modal {...bindings} width="60rem" style={{ minWidth: '30rem', width: 'max-content' }}>
        ...
        <Modal.Content>
          <Text>
            The Game of Life is not your typical computer game. It is a cellular automaton, and was invented by Cambridge mathematician John Conway. This game became widely known when it was mentioned
            in an article published by Scientific American in 1970. It consists of a collection of cells which, based on a few mathematical rules, can live, die or multiply. Depending on the initial
