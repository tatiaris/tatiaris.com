...
export default function Home() {
  ...
  return (
    <>
      ...
      <Page>
        <Head>
          <title>Rishabh Tatia | Blog</title>
          ...
          <meta property="og:title" content={`Rishabh Tatia | Blog`} />
          ...
          <meta name="twitter:title" content={`Rishabh Tatia | Blog`} />
